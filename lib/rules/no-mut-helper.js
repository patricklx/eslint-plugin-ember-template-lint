...
class NoMutHelper extends _base.default {
  parseConfig(config) {
    if (!config || !config.setterAlternative) {
      ...
      let errorMessage = (0, _createErrorMessage.default)(this.ruleName, ['  * object -- An object with the following key:', `    * \`setterAlternative\` -- (Optional) If the app defines or depends on a \`{{set}}\` helper,
