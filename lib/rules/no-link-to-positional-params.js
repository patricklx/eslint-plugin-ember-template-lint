...
class NoLinkToPositionalParams extends _base.default {
  visitor() {
    return {
      GlimmerMustacheStatement(node) {
        this.process(node, {
          hasRequiredTextParam: true
        });
      },
      GlimmerBlockStatement(node) {
        this.process(node, {
          hasRequiredTextParam: false
        });
      }
    };
  }
...
exports.default = NoLinkToPositionalParams;
