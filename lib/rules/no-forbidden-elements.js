...
class NoForbiddenElements extends _base {
  parseConfig(config) {
    ...
    let errorMessage = _createErrorMessage(this.ruleName, ['  * boolean - `true` to enable / `false` to disable', '  * array -- an array of strings to forbid, default: ["meta", "style", "html", "style"]', '  * object -- An object with the following keys:', '    * `forbidden` -- An array of forbidden strings'], config);
