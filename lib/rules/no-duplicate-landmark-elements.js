...
class NoDuplicateLandmarkElements extends _base.default {
  constructor(options) {
    super(options);
  ...
  visitor() {
    return {
      GlimmerElementNode(node) {
        const roleAttribute = _astNodeInfo.default.findAttribute(node, 'role');
        ...
        const labelAttribute = _astNodeInfo.default.findAttribute(node, 'aria-label') || _astNodeInfo.default.findAttribute(node, 'aria-labelledby');
