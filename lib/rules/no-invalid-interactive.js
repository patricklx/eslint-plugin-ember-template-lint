...
class NoInvalidInteractive extends _base.default {
  parseConfig(config) {
  ...
  visitor() {
    ...
    let visitor = {
      enter(node) {
        let isInteractive = (0, _isInteractiveElement.default)(node) || this.isCustomInteractiveElement(node) || (0, _isAngleBracketComponent.default)(this.scope, node);
