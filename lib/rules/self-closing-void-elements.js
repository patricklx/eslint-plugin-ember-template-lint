...
class SelfClosingVoidElements extends _base {
  parseConfig(config) {
    ...
    let errorMessage = _createErrorMessage(this.ruleName, ['  * boolean - `true` to enable and `false` to disable', '  * "require" - checks for closing tags in void elements'], config);
