...
exports.default = exports.CONFIG_ERROR_MESSAGE = void 0;
exports.parseConfig = parseConfig;
var _base = _interopRequireDefault(require("./_base.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const CONFIG_ERROR_MESSAGE = 'Invalid rule configuration for `no-multiple-empty-lines` found';
exports.CONFIG_ERROR_MESSAGE = CONFIG_ERROR_MESSAGE;
class NoMultipleEmptyLines extends _base.default {
  parseConfig(config) {
    return parseConfig(config);
  }
  visitor() {
    // Swallow the final newline, as some editors add it automatically and we don't want it to cause an issue
    let allLines = this.source[this.source.length - 1] === '' ? this.source.slice(0, -1) : this.source;
    return {
      GlimmerTemplate: {
        exit(node) {
          ...
          if (this.mode === 'fix') {
            ...
            for (const element of copyNode) {
              if (element['type'] === 'GlimmerTextNode') {
...
exports.default = NoMultipleEmptyLines;
