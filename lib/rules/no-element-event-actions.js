...
class NoElementEventActions extends _base {
  parseConfig(config) {
...
function parseConfig(config, ruleName) {
  ...
  let errorMessage = _createErrorMessage(ruleName, ['  * boolean - `true` to enable / `false` to disable', '  * object -- An object with the following keys:', '    * `requireActionHelper` -- Only apply this rule even when the {{action}} helper is present (defaults to `false`)'], config);
