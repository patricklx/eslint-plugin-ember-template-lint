...
class NoPassedInEventHandlers extends _base.default {
  parseConfig(config) {
  ...
  visitor() {
    return {
      ...
      GlimmerMustacheStatement(node) {
        ...
        if (path.type === 'GlimmerPathExpression' && ['input', 'textarea'].includes(path.original)) {
          return;
        }
...
exports.default = NoPassedInEventHandlers;
