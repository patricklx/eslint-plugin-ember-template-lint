...
function _default(messages) {
  ...
  for (let item of messages) {
    ...
    switch (item.severity) {
      case _linter.default.IGNORE_SEVERITY:
        {
          continue;
        }
      case _linter.default.ERROR_SEVERITY:
        {
          errorCount++;
      ...
      case _linter.default.WARNING_SEVERITY:
        {
          warningCount++;
      ...
      case _linter.default.TODO_SEVERITY:
        {
          todoCount++;
