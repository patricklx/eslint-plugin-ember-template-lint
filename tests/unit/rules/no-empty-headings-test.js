...
generateRuleTests({
  ...
  bad: [
    ...
    {
      template:
        '<h1> &nbsp; <div aria-hidden="true">Some hidden text</div></h1>',
      verifyResults(results) {
        expect(results).toMatchInlineSnapshot(`
          [
            {
    ...
    {
      template:
        "<h1><span hidden>{{#component}}Inaccessible text{{/component}}</span></h1>",
      verifyResults(results) {
        expect(results).toMatchInlineSnapshot(`
          [
            {
    ...
    {
      template:
        "<h1><span hidden><CustomComponent>Inaccessible text</CustomComponent></span></h1>",
      verifyResults(results) {
        expect(results).toMatchInlineSnapshot(`
          [
            {
    ...
    {
      template:
        '<div role="heading" aria-level="1"><span hidden>Inaccessible text</span></div>',
      verifyResults(results) {
        expect(results).toMatchInlineSnapshot(`
          [
            {
